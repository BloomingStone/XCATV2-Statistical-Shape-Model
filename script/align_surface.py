...
def deform_surface(source_surface: pv.PolyData, target_surface: pv.PolyData, max_point_num = 1000) -> pv.PolyData:
    ...
    for label in labels:
        ...
        reg = torchcpd.DeformableRegistration(X=target_points[::100], Y=source_points, device='cuda')
        new_points, _ = reg.register()
